...
Base.tan(a::Dual) = Dual(tan(a.r), a.d / (pow(cos(a.r), 2)))
Base.asin(a::Dual) = Dual(asin(a.r), a.d / sqrt(1 - pow(a.r, 2)))
Base.acos(a::Dual) = Dual(acos(a.r), -a.d / sqrt(1 - pow(a.r, 2)))
Base.atan(a::Dual) = Dual(atan(a.r), a.d / (1 + pow(a.r, 2)))
Base.sinh(a::Dual) = Dual(sinh(a.r), a.d * cosh(a.r))
Base.cosh(a::Dual) = Dual(cosh(a.r), a.d * sinh(a.r))
Base.tanh(a::Dual) = Dual(tanh(a.r), a.d / pow(cosh(a.r), 2))
